...
<div id="heading">
        ...
        <div class="column search-column">
            <div class="search">
                <form id="searchForm" action="index.php" method="GET">
                    ...
                    <input type="hidden" name="file" value="./orders">
    ...
    <div>
        ...
        $query = "SELECT * FROM orders $filter";
        $result = $conn->query($query);
        if ($result) {
            echo "<table border=1 id='orderTable'>";
            echo "<tr><th>S.N</th><th>Order ID</th><th>User Phone</th><th>Total Amount</th><th>Delivery Address</th><th>Order Note</th><th>Payment Mode</th><th>Order Date</th><th>Order Items</th><th>Action</th></tr>";
            $i = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <td>
                    <button class='orange-button1' id="delivered"
                        onclick="return confirm('Is product delivered? Click OK for yes')">
                        <a href='<?php echo "orders_code.php?id=" . $order_id; ?>'>Delivered</a>
                    </button>
                </td>
                <?php
                echo "</tr>";
