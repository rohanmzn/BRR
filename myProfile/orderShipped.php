...
<body>
    ...
    <div>
        ...
        if (isset($_SESSION['Username'])) {
            ...
            $sql = "SELECT * FROM delivered WHERE user_email = ? ORDER BY order_id DESC";
            if ($stmt = mysqli_prepare($conn, $sql)) {
                ...
                if ($result) {
                    ...
                    echo "<tr><th>S.N</th><th>Order ID</th><th>Payment Mode</th><th>Total Amount</th><th>Received On</th><th>Order Items</th><th>Receipt</th></tr>";
                    $i = 1;
